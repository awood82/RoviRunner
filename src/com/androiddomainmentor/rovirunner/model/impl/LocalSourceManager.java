...
public class LocalSourceManager implements ILocalSourceManager
{
    ...
    public List<AudioTrackMetadata> getAudioTracks( Context context )
    {
        ...
        trackList.addAll( getAudioTracksFromMediaStore( context,
    ...
    public List<AudioTrackMetadata> getAudioTracksFromMediaStore( Context context,
                                                                  Uri uri )
    {
        List<AudioTrackMetadata> trackList = new ArrayList<AudioTrackMetadata>();
        ...
        String[] projectionColumns = { MediaStore.Audio.Media.DATA, // path
